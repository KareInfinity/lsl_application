...
export class CableService extends BaseService {
	...
	sql_insert_cable: string = `Insert into tblCable (cable_name, created_by, created_on, is_active) 
    OUTPUT INSERTED.id values (@cable_name, @created_by, @created_on, @is_active)`;
	...
	async insertCableInfo(_cable_model: CableModel): Promise<boolean> {
